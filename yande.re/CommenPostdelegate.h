...
-(void)SetDidSelectBlock:(Didselect)block;/**>设置点击对应cell后处理的Block回调*/
-(void)setCellModifyBlock:(CellModify)block;/**>设置Cell处理方法，设置后可对cell进行二次更改，默认格式为UIImageView Tag=2,UIlabel Tag=3*/
